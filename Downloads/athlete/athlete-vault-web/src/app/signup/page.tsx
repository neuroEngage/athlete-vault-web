...
export default function Signup() {
    ...
    const [phone, setPhone] = useState(''); // Captured but not used for auth yet
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            const { error } = await supabase.auth.signUp({
                ...
                options: {
                    data: {
                        phone_number: phone, // Store phone in metadata
                    },
                },
            });
            ...
            <div className={styles.container}>
                <div className={styles.authCard}>
                    <div className={styles.header}>
                        ...
                        <p className={styles.subtitle}>Join 1M+ athletes discovering their potential</p>
                    </div>
